    ...
    def processImage(self, img_path):
        ...
        if self.mainWindow.group_colorCheckerDetection:
            ...
            if self.mainWindow.radioButton_colorCheckerSmall.isChecked():
                cc_position, cropped_cc, cc_crop_time = self.colorchipDetect.process_colorchip_small(reduced_img, original_size, stride_style='quick', high_precision=False, buffer_size=100)
            else:
