...
class Ui_Wizard(object):
    def setupUi(self, Wizard):
        ...
        self.label_31 = QtWidgets.QLabel(self.intro_Page)
        font = QtGui.QFont()
        ...
        self.label = QtWidgets.QLabel(self.path_setup_page)
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, 0, 595, 447))
        ...
        self.label_14 = QtWidgets.QLabel(self.bcRead_setup_page)
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.label_17 = QtWidgets.QLabel(self.blurDetect_setup_page)
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.gridLayout_9.addItem(spacerItem5, 4, 1, 1, 1)
        ...
        self.gridLayout_9.addItem(spacerItem6, 3, 1, 1, 1)
        self.label_34 = QtWidgets.QLabel(self.ccRead_setup_page1)
        font = QtGui.QFont()
        font.setPointSize(14)
        self.label_34.setFont(font)
        self.label_34.setObjectName("label_34")
        self.gridLayout_9.addWidget(self.label_34, 0, 0, 1, 2)
        self.label_33 = QtWidgets.QLabel(self.ccRead_setup_page1)
        self.label_33.setWordWrap(True)
        self.label_33.setObjectName("label_33")
        self.gridLayout_9.addWidget(self.label_33, 1, 0, 1, 2)
        self.crc_annotation_layout_2 = QtWidgets.QFrame(self.ccRead_setup_page1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.crc_annotation_layout_2.sizePolicy().hasHeightForWidth())
        self.crc_annotation_layout_2.setSizePolicy(sizePolicy)
        self.crc_annotation_layout_2.setObjectName("crc_annotation_layout_2")
        self.crc_annotation_layout = QtWidgets.QVBoxLayout(self.crc_annotation_layout_2)
        self.crc_annotation_layout.setObjectName("crc_annotation_layout")
        self.gridLayout_9.addWidget(self.crc_annotation_layout_2, 4, 0, 1, 1)
        ...
        self.label_15 = QtWidgets.QLabel(self.ccRead_setup_page2)
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.label_29 = QtWidgets.QLabel(self.group_verifyRotation)
        self.label_29.setWordWrap(True)
        self.label_29.setObjectName("label_29")
        self.gridLayout_5.addWidget(self.label_29, 1, 0, 1, 3)
        self.gridLayout.addWidget(self.group_verifyRotation, 3, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.group_scaleDetermination, 2, 0, 1, 1)
        ...
        self.label_30 = QtWidgets.QLabel(self.groupBox_performWhiteBalance)
        self.label_30.setWordWrap(True)
        self.label_30.setObjectName("label_30")
        self.gridLayout_4.addWidget(self.label_30, 0, 0, 1, 1)
        self.gridLayout.addWidget(self.groupBox_performWhiteBalance, 4, 0, 1, 1)
        ...
        self.label_20 = QtWidgets.QLabel(self.eqRead_setup_page)
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.label_22 = QtWidgets.QLabel(self.metaRead_setup_page)
        font = QtGui.QFont()
        font.setPointSize(14)
    ...
    def retranslateUi(self, Wizard):
        ...
        self.label_31.setText(_translate("Wizard", "Profile Settings Wizard"))
        self.label_32.setText(_translate("Wizard", "<html><head/><body><p>Herbarium Application for Specimen Auto-Processing (HerbASAP) was developed to automate the steps required to create web ready derivative images from &quot;Raw&quot; specimen images, so called post-processing.</p><p>HerbASAP has many features, this wizard will guide you through configuring a profile to store settings. Profiles may be configured for multiple projects.</p><p>Throughout the wizard, optional features may be enabled or disabled using checkboxes.</p></body></html>"))
        self.label.setText(_translate("Wizard", "Input / Output Settings"))
        ...
        self.label_14.setText(_translate("Wizard", "File Naming by Barcode / DataMatrix Value"))
        self.label_16.setText(_translate("Wizard", "<html><head/><body><p>HerbASAP can name processed image derivatives based on catalog numbers found as barcodes or data matrices in the input image. If multiple distinct codes are found in an image, a copy is saved for each code.</p><p>Undesired or partial reads are filtered using &quot;regular expression&quot; (regex) patterns. To use this feature you\'ll need to enter details concerning the expected catalog number. Use the &quot;Preview&quot; text to view the type of pattern expected based on your inputs.</p><p>- The Decoder backend determines what underlying software will be used to decode values in the image. Barcodes should be decoded using &quot;zbar.&quot; Data matrices should be decoded using &quot;libdmtx.&quot;</p><p>- Entering an empty &quot;Catalog Number Prefix&quot; with 0 &quot;Digits,&quot; will result in all values being acceptable.</p><p>- Multiple patterns can used simultaneously. The &quot;Add&quot; / &quot;Remove&quot; buttons edit which patterns are acceptable.</p></body></html>"))
        ...
        self.label_17.setText(_translate("Wizard", "Blur Detection"))
        self.label_18.setText(_translate("Wizard", "<html><head/><body><p>HerbASAP can to a limited degree, verify that images are in focus. </p><p><br/></p><p>To do this it calculates the variance of the Laplace Operator (Laplacian) for the image. The Laplacian is normalized using the image variance to account for image &quot;busyness&quot; (e.g., dissected leaves as compared to simple leaves). To use this feature, a threshold value must be set. If the normalized Laplacian is lower than the threshold value, a notice dialog will be provided.</p><p><br/></p><p>- Lower values are more blur tolerant.</p></body></html>"))
        ...
        self.label_34.setText(_translate("Wizard", "Color Reference Chart Detection Setup"))
        self.label_33.setText(_translate("Wizard", "<html><head/><body><p>HerbASAP has several features which depend the presence of a color reference chart (CRC).</p><p>CRC location is determined using the methods described by Ledesma et al. 2019. To use these features, you must select which CRC type is expected, and draw a box over the CRC in the example image.</p></body></html>"))
        self.label_15.setText(_translate("Wizard", "Color Reference Chart Features"))
        self.label_19.setText(_translate("Wizard", "<html><head/><body><p>HerbASAP has several features which depend the presence of a color reference chart (CRC).</p><p>Features dependent on the CRC are explained below.</p></body></html>"))
        ...
        self.label_colorCheckerPosition.setText(_translate("Wizard", "Correct CRC Position"))
        self.label_29.setText(_translate("Wizard", "<html><head/><body><p>- Image rotation: derivative images can be rotated to place the CRC a the specified position (e.g., &quot;Lower Right&quot;).</p></body></html>"))
        self.group_scaleDetermination.setTitle(_translate("Wizard", "Determine image scale using known color patch sizes"))
        self.label_27.setText(_translate("Wizard", "<html><head/><body><p>- Image scale determination: A pixel to mm ratio is determined using the internal area of CRC color patches. This ratio is annotated in the metadata of the derivative images. <span style=\" font-weight:600;\">Assumes CRC is flat on the focal surface.</span></p></body></html>"))
        self.groupBox_performWhiteBalance.setTitle(_translate("Wizard", "Perform white balance using color checker"))
        self.label_30.setText(_translate("Wizard", "<html><head/><body><p>- White balance: The whitest color patch of the CRC is used as a point reference for white balanceing image derivatives.</p></body></html>"))
        self.label_20.setText(_translate("Wizard", "Distortion Corrections"))
        ...
        self.label_22.setText(_translate("Wizard", "Metadata"))
