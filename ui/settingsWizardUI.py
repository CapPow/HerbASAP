...
class Ui_Wizard(object):
    def setupUi(self, Wizard):
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, 0, 802, 471))
        ...
        self.verticalLayout_9 = QtWidgets.QVBoxLayout(self.ccRead_setup_page1)
        ...
        self.group_windowSize = QtWidgets.QGroupBox(self.ccRead_setup_page1)
        self.group_windowSize.setEnabled(True)
        self.group_windowSize.setTitle("")
        self.group_windowSize.setObjectName("group_windowSize")
        self.gridLayout_9 = QtWidgets.QGridLayout(self.group_windowSize)
        self.gridLayout_9.setObjectName("gridLayout_9")
        self.label_windowSize = QtWidgets.QLabel(self.group_windowSize)
        self.label_windowSize.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_windowSize.setObjectName("label_windowSize")
        self.gridLayout_9.addWidget(self.label_windowSize, 1, 1, 1, 1)
        self.spinBox_partitionSize = QtWidgets.QSpinBox(self.group_windowSize)
        self.spinBox_partitionSize.setMaximum(9999)
        self.spinBox_partitionSize.setSingleStep(5)
        self.spinBox_partitionSize.setObjectName("spinBox_partitionSize")
        self.gridLayout_9.addWidget(self.spinBox_partitionSize, 1, 2, 1, 1)
        self.pushButton_setWindowSize = QtWidgets.QPushButton(self.group_windowSize)
        self.pushButton_setWindowSize.setObjectName("pushButton_setWindowSize")
        self.gridLayout_9.addWidget(self.pushButton_setWindowSize, 1, 0, 1, 1)
        self.gridLayout_2.addWidget(self.group_windowSize, 1, 1, 1, 1)
        ...
        self.verticalLayout_9.addWidget(self.pushButton_selectExampleImage_1)
        ...
        self.verticalLayout_9.addWidget(self.label_loadedExampleFile_1)
        ...
        self.verticalLayout_9.addWidget(self.pushButton_testCRCDetection)
        ...
        self.verticalLayout_9.addWidget(self.label_crcDetection_results)
        ...
        self.gridLayout_16.addItem(spacerItem9, 2, 2, 1, 1)
        ...
        self.gridLayout_16.addItem(spacerItem10, 0, 0, 1, 1)
        ...
        self.label_12 = QtWidgets.QLabel(self.group_equipmentDetection)
        self.label_12.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_12.setObjectName("label_12")
        self.gridLayout_7.addWidget(self.label_12, 6, 0, 1, 1)
        self.label_10 = QtWidgets.QLabel(self.group_equipmentDetection)
        self.label_10.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_10.setObjectName("label_10")
        self.gridLayout_7.addWidget(self.label_10, 5, 0, 1, 1)
        self.comboBox_lensModel = QtWidgets.QComboBox(self.group_equipmentDetection)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Ignored, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.comboBox_lensModel.sizePolicy().hasHeightForWidth())
        self.comboBox_lensModel.setSizePolicy(sizePolicy)
        self.comboBox_lensModel.setObjectName("comboBox_lensModel")
        self.comboBox_lensModel.addItem("")
        self.gridLayout_7.addWidget(self.comboBox_lensModel, 6, 1, 1, 1)
        self.label_camModel = QtWidgets.QLabel(self.group_equipmentDetection)
        self.label_camModel.setText("")
        self.label_camModel.setObjectName("label_camModel")
        self.gridLayout_7.addWidget(self.label_camModel, 5, 1, 1, 1)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 22, 30))
        ...
        self.pushButton_setWindowSize.clicked.connect(Wizard.adaptive_partition_size)
        self.comboBox_crcType.currentTextChanged['QString'].connect(Wizard.crc_type_changed)
        self.spinBox_partitionSize.valueChanged['int'].connect(Wizard.partition_size_changed)
    ...
    def retranslateUi(self, Wizard):
        ...
        self.label_33.setText(_translate("Wizard", "<html><head/><body><p>HerbASAP has several features which depend the presence of a color reference chart (CRC). To use these features, you must select the type of CRC being used. For the best results make sure the CRC remains unobstructed, is not arbitrarily rotated, and is parallell to the focal plane. CRC location is determined using the neural networks described in Ledesma et al. 2019. </p><p>For the &quot;ISA ColorGague Nano&quot; CRC, you must set a window size which ColorNet uses for region proposals. The &quot;Set Window Size&quot; button will attempt to automatically determine an appropriate size, but if necessary it can be manually set.</p><p>For all other CRCs, you must use the &quot;Test CRC Detection&quot; button to ensure proper functionality.</p></body></html>"))
        ...
        self.label_windowSize.setText(_translate("Wizard", "Window Size:"))
        self.pushButton_setWindowSize.setText(_translate("Wizard", "Set Window Size"))
        ...
        self.label_12.setText(_translate("Wizard", "Lens model:"))
        self.label_10.setText(_translate("Wizard", "Camera model:"))
        self.comboBox_lensModel.setWhatsThis(_translate("Wizard", "<html><head/><body><p>Select the correct lens model. If your model is not on the list, this feature is not available.</p></body></html>"))
        self.comboBox_lensModel.setItemText(0, _translate("Wizard", "Not Available (no lens corrections are available)"))
